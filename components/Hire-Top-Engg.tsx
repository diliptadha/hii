...
import Optionmodal2 from "./Optionmodal2";
      ...
      {isOpen && (
        ...
        >
          <div className=" fixed xs:right-1 xs:top-[80px] md:right-2 md:top-[80px] xl:right-[3rem] xl:top-[70px]">
            <button
              className="bg-tundora flex h-8 w-8 items-center justify-center rounded-full border-transparent text-white"
              onClick={openModal}
            >
          ...
          <div className="  sidebar- no-scrollbar  h-[90%] w-[100%] overflow-y-scroll rounded-xl bg-white py-7 dark:bg-[#000] xs:px-3 md:px-6 lg:flex lg:items-center lg:justify-center lg:px-12">
            {activeModalPage === 1 && (
              <div>
                ...
                <div className="mt-[10px] flex justify-end space-x-[1px] ">
                  <button
            ...
            {activeModalPage === 2 && (
              <div>
                ...
                {isOtherSelected && (
                  <div className="font-outfit my-4 flex justify-start space-x-2 text-gray-900 dark:text-white">
                    <input
                      type="text"
                    ...
                    <button
                      ...
                      className="font-outfit from-tosca to-contessa hover:to-CodGray  rounded-lg border-[2px] border-[#000] bg-gradient-to-t px-[30px] font-semibold text-white hover:from-gray-950 dark:border-white"
                    >
                      {Strings.ADD}
                    </button>
                  </div>
            ...
            {activeModalPage === 4 && (
              <div className="space-y-7">
                <div className="space-y-1">
                  ...
                  <p className="font-outfit font-semibold text-gray-900 dark:text-white xs:text-lg md:text-[16px] lg:text-[16px]">
                    {Strings.QUS_4_SUB}
                  </p>
                </div>
                <div className="font-outfit mt-4 flex justify-start text-[#000] dark:text-white">
                  <input
                    type="text"
                    required
            ...
            {activeModalPage === 5 && (
              <div className="space-y-7">
                ...
                <div className="font-outfit mt-4 flex justify-start text-gray-900 dark:text-white">
                  <input
                    type="text"
                    placeholder="Type your answer here..."
            ...
            {activeModalPage === 6 && (
              <div className="space-y-7">
                ...
                <div className="font-outfit mb-72 mt-4 flex justify-start text-gray-900 dark:text-white">
                  <input
                    type="companyEmail"
            ...
            {activeModalPage === 7 && (
              <div className="space-y-7">
                ...
                <div className="flex xs:flex-col xs:space-y-7 lg:flex-row lg:space-x-12 lg:space-y-0 ">
                  <button
                    className="flex h-12 w-64  items-center rounded-full border-2 border-[#000] px-3 dark:border-white"
                    onClick={() => {
                  ...
                  >
                    ...
                    <p className="mr-16 font-semibold text-gray-900 dark:text-white xs:text-base lg:text-lg">
                      1-10
                    </p>
                  ...
                  >
                    ...
                    <p className="mr-14 font-semibold text-gray-900 dark:text-white xs:text-base lg:text-lg">
                      10-50
                    </p>
            ...
            {activeModalPage === 8 && (
              <div className="space-y-7">
                <div className="space-y-1">
                  <p className="font-outfit lg:text-[24px font-bold text-gray-900 dark:text-white xs:text-xl md:text-[24px]">
                    {Strings.QUS_8}
                  </p>
                  <p className="font-outfit font-semibold text-gray-900 dark:text-white xs:text-lg md:text-xl lg:text-[16px]">
                ...
                <div className="flex justify-end space-x-[1px] ">
                  ...
                  <button
                    onClick={() => {
                      console.log("anythingelse:", message);
                      if (activeModalPage < 9) {
                        setActiveModalPage(activeModalPage + 1);
                      }
                    }}
            ...
            {activeModalPage === 9 && (
              <div className="space-y-7">
                ...
                {isOtherSelected2 && (
                  <div className="font-outfit mt-4 flex justify-start space-x-2 text-gray-900 dark:text-white">
                    <input
                      type="text"
                      placeholder="Enter your other skills here..."
                    ...
                    <button
                      ...
                      className="font-outfit from-tosca to-contessa hover:to-CodGray rounded-lg   border border-[#000] bg-gradient-to-t font-semibold text-gray-900 hover:from-gray-950 dark:border-white dark:text-white xs:px-3 lg:px-5"
                    >
                      {Strings.ADD}
                    </button>
                  </div>
